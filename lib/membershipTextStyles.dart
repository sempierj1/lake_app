...
class MembershipTextStyle{
    ...
    TextStyle header(BuildContext context){
      return Theme.of(context).textTheme.display1.copyWith(fontFamily: 'Raleway', fontSize: 30.0, color: Colors.black);
    }
    ...
    TextStyle subText(BuildContext context){
      return Theme.of(context).textTheme.display1.copyWith(fontFamily: 'Raleway',
          fontSize: 15.0,
          color: Colors.grey);
    }
